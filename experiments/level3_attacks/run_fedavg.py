"""
Level 3: FedAvg with Byzantine Attacks

Runs FedAvg aggregation with configurable Byzantine attacks.
Tests robustness against Random Noise and Sign Flipping attacks.
"""
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='Level 3: FedAvg with Byzantine Attacks')
    parser.add_argument(
        '--attack',
        type=str,
        default='none',
...
def main():
    ...
    print("=" * 70)
    print("Level 3: FedAvg with Byzantine Attacks")
    print("=" * 70)
    print(f"Configuration:")
    print(f"  Aggregation Method: FedAvg")
    ...
    logger = MetricsLogger(
        log_dir='./results',
        experiment_name=f'level3_fedavg{attack_suffix}'
    )
    ...
    # Start simulation
    print(f"\nStarting FedAvg simulation ({NUM_ROUNDS} rounds)...")
