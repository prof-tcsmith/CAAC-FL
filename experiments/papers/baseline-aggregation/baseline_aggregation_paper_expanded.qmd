...
Krum [@blanchard2017machine], coordinate-wise median [@yin2018byzantine], and trimmed mean were designed for adversarial settings. Our results for coordinate-wise median (FedMedian) show that even without adversaries, this method underperforms FedAvg when clients have imbalanced data---suggesting that Byzantine-robust methods may incur a "cost of robustness" in honest-client scenarios. Whether Krum and trimmed mean exhibit similar behavior remains to be tested.
