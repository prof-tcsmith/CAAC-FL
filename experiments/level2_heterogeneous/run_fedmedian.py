"""
Run Level 2 experiment with FedMedian aggregation on non-IID data.
"""
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='Level 2: FedMedian with Non-IID Data')
...
def main():
    ...
    print("=" * 60)
    print(f"Level 2: FedMedian with Non-IID Data (Dirichlet α={args.alpha})")
    print("=" * 60)
    ...
    print(f"  Heterogeneity (KL divergence): {stats['heterogeneity_metrics']['mean_kl_divergence']:.4f}")
    print(f"  Results saved to: ./results/level2_fedmedian_metrics.*")
