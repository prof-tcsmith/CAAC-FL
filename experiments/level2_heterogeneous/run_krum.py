"""
Run Level 2 experiment with Krum aggregation on non-IID data.
"""
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='Level 2: Krum with Non-IID Data')
...
def main():
    ...
    print("=" * 60)
    print(f"Level 2: Krum with Non-IID Data (Dirichlet α={args.alpha})")
    print("=" * 60)
    ...
    print(f"  Heterogeneity (KL divergence): {stats['heterogeneity_metrics']['mean_kl_divergence']:.4f}")
    print(f"  Results saved to: ./results/level2_krum_metrics.*")
